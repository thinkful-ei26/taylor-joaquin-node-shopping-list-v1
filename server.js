...
Recipes.create('Mac n Cheese', ['noodles', 'butter', 'cheese']);
Recipes.create('Chicken Soup', ['noodles', 'butter', 'chicken']);
Recipes.create('Bratwurst Soup', ['Bratwurst', 'butter', 'cheese']);
